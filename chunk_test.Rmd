...
Can we invoke an external chunk that relies on objects defined here in the RMarkdown itself? Let's find out. First we assign a variable `newvar`
...
and then we call a chunk that prints its contents and plots it with the default method.
